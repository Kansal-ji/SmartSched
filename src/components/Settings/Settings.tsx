        ...
        <div className="p-6">
          ...
          {activeTab === 'notifications' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-gray-900">Timetable Changes</h4>
                    <p className="text-sm text-gray-500">Get notified about schedule changes</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Notifications about leave requests</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-gray-900">Exam Alerts</h4>
                    <p className="text-sm text-gray-500">Get notified about upcoming exams</p>
                  </div>
                  <input
                    type="checkbox"
                    checked={notificationSettings.examAlerts}
                    onChange={(e) => setNotificationSettings({ ...notificationSettings, examAlerts: e.target.checked })}
                    className="rounded"
                  />
                </div>
              </div>
          ...
          {activeTab === 'appearance' && (
            <div className="space-y-6">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        name="theme"
                        value="auto"
                        checked={systemSettings.theme === 'auto'}
                        onChange={(e) => setSystemSettings({ ...systemSettings, theme: e.target.value })}
                        className="mr-2"
                      />
                      Auto
              ...
              <div className="flex justify-end">
                <button
                  onClick={() => alert('Appearance settings updated!')}
                  className="flex items-center space-x-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
                >
                  <Save className="w-4 h-4" />
                  <span>Save Changes</span>
